...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/09 16:12:54 by akorchyn          #+#    #+#             */
/*   Updated: 2019/02/09 16:12:54 by akorchyn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int			null(t_mask *mask, void *data)
{
	...
	iflong = mask->l || mask->ll;
	if (((iflong && (long long)data == 0)
		|| (!iflong && (int)data == 0)) && mask->accurancy == 0)
		return (0);
	return (-1);
}
